...
public class FiltersBottomSheet extends BottomSheetDialogFragment {
    ...
    @Override public void onAttach(@NonNull Context context) {
        ...
        if (getParentFragment() instanceof OnApplyFilters) callback = (OnApplyFilters) getParentFragment();
        else if (context instanceof OnApplyFilters) callback = (OnApplyFilters) context;
    }
    ...
    @Override public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        allTypes = getArguments().getStringArrayList(ARG_TYPES);
        allGens = getArguments().getStringArrayList(ARG_GENS);
